    ...
    private static void generarOperacionFlotantes(String op1, String op2, String operador) { 
        ...
        switch (operador) {
            ...
            case "/":
                ...
                String _cero = ocuparAuxiliar(TablaTipos.ULONG_TYPE);
