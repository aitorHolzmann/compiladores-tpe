...
public class TablaTipos {
    ...
    private static final String[][] tiposSumaResta = { { ULONG_TYPE, DOUBLE_TYPE, ERROR_TYPE },
                                                       { DOUBLE_TYPE, DOUBLE_TYPE, ERROR_TYPE },
                                                       { ERROR_TYPE, ERROR_TYPE, ERROR_TYPE} };
    private static final String[][] tiposMultDiv = { { ULONG_TYPE, DOUBLE_TYPE, ERROR_TYPE },
                                                     { DOUBLE_TYPE, DOUBLE_TYPE, ERROR_TYPE },
                                                     { ERROR_TYPE, ERROR_TYPE, ERROR_TYPE} };
    private static final String[][] tiposComparadores = { { ULONG_TYPE, DOUBLE_TYPE, ERROR_TYPE }, 
                                                          { DOUBLE_TYPE, DOUBLE_TYPE, ERROR_TYPE },
                                                          { ERROR_TYPE, ERROR_TYPE, ERROR_TYPE } };
    ...
    public static String getTipo(String op) {
        int puntOp = TablaSimbolos.obtenerSimboloAmbito(op);
    ...
    private static int getNumeroTipo(String tipo) {
        if (tipo.equals(ULONG_TYPE)) return ULONG;
